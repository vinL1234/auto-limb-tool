...
# Builds IK/FK chains, controls, constraints, and the IK/FK switch.
class RigMixin(object):
    ...
    def build_parentCons_IKFK(
        ...
        # Constrain each bind joint to its matching IK and FK joints.
        constraints = []
    ...
    def connect_ikfk_switch(
        ...
        # Drive IK and FK constraint weights with one switch attribute.
    ...
    def create_fk_controls(self, fk_chain, primary_axis):
        # Parent FK controls into a hierarchy that follows the joint chain.
        fk_ctrls = []
        fk_offsets = []
        previous_ctrl = None
    ...
    def build_ikfk_system(
        ...
        # Assemble the complete IK/FK rig from the selected bind chain.
