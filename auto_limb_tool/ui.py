...
# Creates the Maya interface and connects UI actions to rig-building methods.
class UiMixin(object):
    ...
    def show_main_page(self):
        # Display the standard arm and leg workflow.
        self.clear_ui()

        cmds.text(label="Auto Limb Builder", height=30, align="center")
    ...
    def show_custom_page(self):
        # Display controls for building a custom joint range.
        self.clear_ui()
    ...
    def show(self):
        # Create a fresh window to avoid duplicate Maya UI instances.
